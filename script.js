const preguntas = [
  ...
  { clave: "jornada_no_abusiva", texto: "¿La jornada laboral no es abusiva?", tipo: "si_no", imagen: "imagenes/jornada_no_abusiva.jpg" },
  { clave: "transporte", texto: "Impacto del transporte (1=muy alto, 5=muy bajo)", tipo: "valor", imagen: "imagenes/transporte.jpg" },
  { clave: "empaquetado", texto: "Sostenibilidad del empaquetado (1=nada, 5=muy sostenible)", tipo: "valor", imagen: "imagenes/empaquetado.jpg" },
  { clave: "distancia", texto: "Cercanía de producción (1=muy lejos, 5=muy cerca)", tipo: "valor", imagen: "imagenes/distancia.jpg" },
  { clave: "uso_quimicos", texto: "¿Se usan químicos agresivos en el proceso?", tipo: "si_no", imagen: "imagenes/uso_quimicos.jpg" },
  { clave: "material_natural", texto: "¿El material es natural?", tipo: "si_no", imagen: "imagenes/material_natural.jpg" },
  { clave: "material_sintetico", texto: "¿El material es sintético?", tipo: "si_no", imagen: "imagenes/material_sintetico.jpg" },
  ...
  { clave: "material_reciclado", texto: "¿El material proviene de materiales reciclados?", tipo: "si_no", imagen: "imagenes/material_reciclado.jpg" },
  { clave: "marca_ecologica", texto: "¿Pertenece a una marca o línea ecológica?", tipo: "si_no", imagen: "imagenes/marca_ecologica.jpg" },
  { clave: "duracion", texto: "Duración general de la prenda (1=baja, 5=alta)", tipo: "valor", imagen: "imagenes/duracion.jpg" },
  { clave: "resistencia_uso", texto: "Resistencia al uso (1=baja, 5=alta)", tipo: "valor", imagen: "imagenes/resistencia_uso.jpg" },
  { clave: "resistencia_lavado", texto: "Resistencia al lavado (1=baja, 5=alta)", tipo: "valor", imagen: "imagenes/resistencia_lavado.jpg" },
  { clave: "vida_util", texto: "Vida útil estimada (1=corta, 5=larga)", tipo: "valor", imagen: "imagenes/vida_util.jpg" },
  { clave: "repelencia_agua", texto: "Repelencia al agua (1=nula, 5=excelente)", tipo: "valor", imagen: "imagenes/repelencia_agua.jpg" },
  { clave: "cuidado", texto: "Facilidad de cuidado (1=difícil, 5=fácil)", tipo: "valor", imagen: "imagenes/cuidado.jpg" },
];
