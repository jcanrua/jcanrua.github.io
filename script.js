const preguntas = [
  ...
  { clave: "uso_quimicos", texto: "¿Se usan químicos agresivos en el proceso?", tipo: "si_no", imagen: "imagenes/uso_quimicos.jpeg" },
  { clave: "material_natural", texto: "¿El material es natural?", tipo: "si_no", imagen: "imagenes/material_natural.jpeg" },
  { clave: "material_sintetico", texto: "¿El material es sintético?", tipo: "si_no", imagen: "imagenes/material_sintetico.jpeg" },
  { clave: "reciclable", texto: "¿El material es reciclable?", tipo: "si_no", imagen: "imagenes/reciclable.jpeg" },
  { clave: "biodegradable", texto: "¿El material es biodegradable?", tipo: "si_no", imagen: "imagenes/biodegradable.jpeg" },
  { clave: "material_reciclado", texto: "¿El material proviene de materiales reciclados?", tipo: "si_no", imagen: "imagenes/material_reciclado.jpeg" },
  { clave: "marca_ecologica", texto: "¿Pertenece a una marca o línea ecológica?", tipo: "si_no", imagen: "imagenes/marca_ecologica.jpeg" },
  { clave: "duracion", texto: "Duración general de la prenda (1=baja, 5=alta)", tipo: "valor", imagen: "imagenes/duracion.jpeg" },
  { clave: "resistencia_uso", texto: "Resistencia al uso (1=baja, 5=alta)", tipo: "valor", imagen: "imagenes/resistencia_uso.jpeg" },
  { clave: "resistencia_lavado", texto: "Resistencia al lavado (1=baja, 5=alta)", tipo: "valor", imagen: "imagenes/resistencia_lavado.jpeg" },
  { clave: "vida_util", texto: "Vida útil estimada (1=corta, 5=larga)", tipo: "valor", imagen: "imagenes/vida_util.jpeg" },
  { clave: "repelencia_agua", texto: "Repelencia al agua (1=nula, 5=excelente)", tipo: "valor", imagen: "imagenes/repelencia_agua.jpeg" },
  { clave: "cuidado", texto: "Facilidad de cuidado (1=difícil, 5=fácil)", tipo: "valor", imagen: "imagenes/cuidado.jpeg" },
];
